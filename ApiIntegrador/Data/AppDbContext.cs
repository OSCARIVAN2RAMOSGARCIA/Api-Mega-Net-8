...
namespace ApiIntegrador.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // PROMOCIONCONFIGURACION — Aquí está lo importante:
            modelBuilder.Entity<PromocionConfiguracion>().ToTable("PromocionConfiguracion");
...
modelBuilder.Entity<PromocionConfiguracion>()
    ...
    .WithMany(p => p.PromocionConfiguraciones)
